...
declare namespace WoWAPI {
  ...
  type SetPointArguments = [string, WoWAPI.Frame | string, string, number, number];
  ...
  class Region extends UIObject {
    ...
    SetPoint(point: string, relativeFrame: Region | string, relativePoint: string, xOffset?: number, yOffset?: number): void;
